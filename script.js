...
const sunset = async () => {
  ...
  const primary = Array.prototype.slice.call(
    document.getElementsByClassName('l-first')
  );
  const secondary = Array.prototype.slice.call(
    document.getElementsByClassName('l-second')
  );
...
const sunrise = async () => {
  ...
  sun.classList.remove('hvr-sink');
  const primary = Array.prototype.slice.call(
    document.getElementsByClassName('d-first')
  );
  const secondary = Array.prototype.slice.call(
    document.getElementsByClassName('d-second')
  );
  for (let p of primary) {
